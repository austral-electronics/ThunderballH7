##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.15.2] date: [Wed Apr 13 17:32:43 CEST 2022] 
##########################################################################################################################
...
# flash
#######################################
OPENOCD_PATH = ..\\toolchain\\OpenOCD-20211118-0.11.0\\bin
flash:
ifeq ($(FLASH), Y)
	$(OPENOCD_PATH)\\openocd -f interface/stlink.cfg -f target/stm32h7x.cfg -c \
...
#######################################
makefsdata: 
	@echo "====== Start building web page ====="
ifeq ($(OS),Windows_NT)
	./Middlewares/Third_Party/LwIP/src/apps/http/makeFSdata \
	targetdir ./Middlewares/Third_Party/LwIP/src/apps/http/fs/ \
	-f ./Middlewares/Third_Party/LwIP/src/apps/http/fs/
	timeout 1
	move "fsdata.c" "./Middlewares/Third_Party/LwIP/src/apps/http"
endif
